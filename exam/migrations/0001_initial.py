    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('department', models.ManyToManyField(to='user.Department', verbose_name='参加考试的部门')),
            ],
            options={
                'verbose_name': '考试',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('choicemu_number', models.PositiveSmallIntegerField(default=10, verbose_name='多选题数')),
                ...
                ('program_number', models.PositiveSmallIntegerField(default=5, verbose_name='编程题数')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('student', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='user.student', verbose_name='员工')),
            ],
            options={
                'verbose_name': '练习',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('score', models.PositiveSmallIntegerField(default='0', verbose_name='分数')),
